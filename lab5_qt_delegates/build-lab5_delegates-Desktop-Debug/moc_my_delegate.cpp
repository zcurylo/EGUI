/****************************************************************************
** Meta object code from reading C++ file 'my_delegate.h'
**
...
#include "../lab5_delegates/my_delegate.h"
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'my_delegate.h' doesn't include <QObject>."
...
static const char qt_meta_stringdata_myDelegate[] = {
    "myDelegate\0\0commitAndCloseEditor()\0"
};
...
void myDelegate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        myDelegate *_t = static_cast<myDelegate *>(_o);
        switch (_id) {
...
const QMetaObject myDelegate::staticMetaObject = {
    { &QStyledItemDelegate::staticMetaObject, qt_meta_stringdata_myDelegate,
